	...
	$(function(){
		...
		$("#approval").click(function(){
			...
			if (!confirm("결제를 제출 하시겠습니까?")) {
				...
				form.append($("<input>", {type:'file', name:"file", value:aprealfile}));
...
<div class="card" id="card">
	<div class="card-body">
		...
		<!-- <form action="./approval" method="post"> -->
				        ...
				        <div class="col-12">
				            <div class="card">
				                <div class="card-body">
				                    ...
				                    <div id="editor" class="apcontent" style="height: 300px;">
									    <p></p>
				                    </div>
				                    <!-- the editor end -->
				                </div>
			...
			<div class="form-group">
				<label class="col-md-3">파일 업로드</label>
			    <div class="col-md-12">
			        <div class="custom-file">
			            <input type="file" class="custom-file-input aporifile" id="validatedCustomFile">
			...
			<div class="form-group last">
				<label class="col-md-12">결재자 선택</label>
				<div class="input-group">
